...
class SplitOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("-v", "--valid_size", type=float, default=0.2, help="percentage split of the training set used for the validation set. Should be a float in the range [0, 1]")
